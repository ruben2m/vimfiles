h3. Continuación del proyecto de "akitaonrails":https://github.com/akitaonrails/vimfiles

Durante mucho tiempo llevo usando estos archivos en mi configuración de VIM para Rails, con la mala suerte que descontinuó este proyecto.

En su página principal recomienda el siguiente plugin:

  https://github.com/JeanMertz/omz-to-prezto

pero en Ubuntu me ha dado problemas por lo que decidí continuar este proyecto.

He implementado soporte para arduino modificando un plugin existente "vim-arduino-master"
* :<map>aa para abrir en Arduino el archivo actual.
* :<map>ac para compilar el archivo actual.
* :<map>ad para compilar y mandar el archivo a la máquina.
...
* "im-jade":https://github.com/statianzo/vim-jade - Vim syntax highlighting for the Jade templating engine
